...
<div class="ohio-socialbar-sc socialbar <?php echo $socialbar_class . $css_class; ?>" 
	...
	<?php if ( $tiktok_link ) : ?>
		<a href="<?php echo $tiktok_link; ?>" target="_blank" class="tiktok<?php echo $link_class; ?>">
			...
			<?php endif; ?>
			<?php if ( $show_text ) : ?>
			<span class="social-text"><?php esc_html_e( 'TikTok', 'ohio-extra' ); ?></span>
			<?php endif; ?>
		</a>
	<?php endif; ?>
	...
	<?php if ( $twitch_link ) : ?>
		<a href="<?php echo $twitch_link; ?>" target="_blank" class="twitch<?php echo $link_class; ?>">
			...
			<?php endif; ?>
			<?php if ( $show_text ) : ?>
			<span class="social-text"><?php esc_html_e( 'Twitch', 'ohio-extra' ); ?></span>
			<?php endif; ?>
		</a>
	<?php endif; ?>
	...
	<?php if ( $mixer_link ) : ?>
		<a href="<?php echo $mixer_link; ?>" target="_blank" class="mixer<?php echo $link_class; ?>">
			...
			<?php endif; ?>
			<?php if ( $show_text ) : ?>
			<span class="social-text"><?php esc_html_e( 'Mixer', 'ohio-extra' ); ?></span>
			<?php endif; ?>
		</a>
	<?php endif; ?>
</div>
...
function ohio_social_networks_func( $atts ) {
	...
	$facebook_link = $twitter_link = $dribbble_link = $pinterest_link = $linkedin_link = $github_link = $instagram_link = $dropbox_link = $vk_link = $youtube_link = $vimeo_link = $behance_link = $tumblr_link = $flickr_link = $reddit_link = $snapchat_link = $whatsapp_link = $quora_link = $vine_link = $digg_link = $foursquare_link = $tiktok_link = $twitch_link = $mixer_link = false;

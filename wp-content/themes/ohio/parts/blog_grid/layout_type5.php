...
?>
<div class="blog-grid blog-grid-type-5<?php echo esc_attr($blog_grid_class); ?> <?php echo esc_attr($hover_effect_class) ?>" <?php echo esc_attr($anim_attrs); ?>>
    <figure class="blog-grid-image">
        ...
        <?php elseif ($ohio_post['media']['audio']) : // Audio format ?>
            ...
            <a data-cursor-class="cursor-link" class="<?php echo esc_attr( $parallax_class ); ?>" href="<?php echo esc_url( $ohio_post['url'] ); ?>">
                <div class="blog-metro-image parallax" <?php echo ' data-ohio-bg-image="' . esc_url( $ohio_post['media']['image'] ) . '"';?>></div>
            </a>
            <?php endif; ?>

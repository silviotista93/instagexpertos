...
<div class="portfolio-item portfolio-item-fullscreen portfolio-grid-type-7 parallax-holder<?php echo esc_attr( implode( ' ', $wrap_classes ) ); ?>"<?php if ($_project_uniqid) {
    echo ' id="' . esc_attr($_project_uniqid) . '"';
} ?><?php if ($project['in_popup']) {
    echo ' data-portfolio-popup="' . esc_attr($project['popup_id']) . '"';
} ?>>

    <div class="portfolio-item-image parallax" <?php echo ' data-ohio-bg-image="' . esc_url($project['featured_image']) . '"'; ?>>

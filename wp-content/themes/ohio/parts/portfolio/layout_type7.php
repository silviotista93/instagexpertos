...
<div class="project-page project layout-type7<?php echo esc_attr($page_container_class); ?>">
    <div class="page-container">
        <?php $is_content_exist = !$show_header_title || $project['date'] || wp_kses( $project['description'], 'basic_html' ) != ''  || $project['custom_content_position'] == 'after_description' || $project['task'] || $project['strategy'] || $project['design'] || $project['client'] || $project['custom_fields'] || $project['tags'] || $project['link']?>

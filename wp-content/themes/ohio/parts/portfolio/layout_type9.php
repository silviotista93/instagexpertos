...
if ($pagination) {
    $slider_pagination_type = OhioOptions::get( 'project_bullets_type', NULL, true );
...
<div class="project-page project layout-type9 <?php echo esc_attr($page_container_class); ?>">
    ...
    <div class="page-container clb__light_section">
        <?php $is_content_exist = wp_kses( $project['description'], 'basic_html' ) != ''  || $project['custom_content_position'] == 'after_description' || $project['task'] || $project['strategy'] || $project['design'] || $project['client'] || $project['custom_fields'] || $project['tags'] || $project['link']?>
        <?php if ( $is_content_exist ) :?>
